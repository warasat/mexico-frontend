...
// import { Phone, PhoneOff } from "feather-icons-react";
            ...
            <div className="card-body pt-0">
              ...
              <nav className="user-tabs mb-4">
                <ul className="nav nav-tabs nav-tabs-bottom nav-justified">
                  <li className="nav-item" onClick={(_e) => Tabclick(1)}>
                    <Link
                  ...
                  <li className="nav-item" onClick={(_e) => setislocation}>
                    <Link
                  ...
                  <li className="nav-item" onClick={(_e) => setisisreview}>
                    <Link
                  ...
                  <li className="nav-item" onClick={(_e) => setiSbusinesshour}>
                    <Link
