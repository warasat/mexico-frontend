                    ...
                    <div className="blog grid-blog">
                      ...
                      <div className="blog-content">
                        <ul className="entry-meta meta-item">
                          ...
                          <li>
                            <i className="isax isax-calendar-1 me-1" />4 Dec
                            2025
                          </li>
                        </ul>
                        ...
                        <p className="mb-0">
                          Discover practical, everyday tips to help you stay
                  ...
                  <div className="col-md-6 col-sm-12">
                    ...
                    <div className="blog grid-blog">
                      ...
                      <div className="blog-content">
                        ...
                        <p className="mb-0">
                          Good nutrition is the foundation of wellness. Explore
                  ...
                  <div className="col-md-6 col-sm-12">
                    ...
                    <div className="blog grid-blog">
                      ...
                      <div className="blog-content">
                        ...
                        <p className="mb-0">
                          Prevention is key to a long, healthy life. Discover
                          the top preventive health measures you can adopt.
                        </p>
                      </div>
                    </div>
                    {/* /Blog Post */}
                  ...
                  <div className="col-md-6 col-sm-12">
                    ...
                    <div className="blog grid-blog">
                      ...
                      <div className="blog-content">
                        ...
                        <p className="mb-0">
                          Earn practical techniques to manage stress and
                          anxiety, and improve your emotional well-being.
                        </p>
                      </div>
                    </div>
                    {/* /Blog Post */}
                  ...
                  <div className="col-md-6 col-sm-12">
                    ...
                    <div className="blog grid-blog">
                      ...
                      <div className="blog-content">
                        ...
                        <p className="mb-0">
                          From AI in diagnostics to cutting-edge treatments,
                          discover how innovation is use in healthcare.
                        </p>
                      </div>
                    </div>
                    {/* /Blog Post */}
                      ...
                      <ul className="latest-posts">
                        ...
                        <li>
                          ...
                          <div className="post-info">
                            ...
                            <h4>
                              <Link to="/blog/blog-grid">
                                Nutrition and Wellness: A Guide to Balanced
                                Eating
                              </Link>
                            </h4>
                          </div>
