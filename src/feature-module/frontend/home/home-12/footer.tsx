                ...
                <div className="col-lg-4 col-sm-6">
                  <div className="footer-links-middle">
                    ...
                    <ul className="social-icons">
											<li><Link to="#" className="social-media"><i className="fa-brands fa-facebook-f"></i></Link></li>
											<li><Link to="#" className="social-media"><i className="fa-brands fa-x-twitter"></i></Link></li>
											<li><Link to="#" className="social-media"><i className="fa-brands fa-instagram"></i></Link></li>
											<li><Link to="#" className="social-media"><i className="fa-brands fa-linkedin-in"></i></Link></li>
											<li><Link to="#" className="social-media"><i className="fa-brands fa-pinterest"></i></Link></li>
										</ul>
                  </div>
                </div>
              </div>
