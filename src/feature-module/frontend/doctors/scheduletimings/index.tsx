...
const ScheduleTiming: React.FC = (props) => {
  ...
  const handleRemoveEmp = (index: number) => {
            ...
            <div className="modal-body">
              <form>
                ...
                <div className="add-more mb-3">
                  <Link to="#" className="add-hours" onClick={handleAddEmp}>
